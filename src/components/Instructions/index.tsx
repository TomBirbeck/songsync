const Instructions = () => {
    return (
        <div className="flex flex-col justify-center items-center gap-4 lg:gap-8 w-full lg:w-2/5 p-4 lg:absolute lg:translate-y-1/4 bg-purple-400 z-10 rounded-lg text-xl lg:text-3xl">
